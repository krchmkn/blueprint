...
underBoss
  ...
  console.log(
    '\n', boss.getType, 'subordinates:', boss.getSubordinatesTypes(),
    '\n\n', underBoss.getType, 'subordinates:', underBoss.getSubordinatesTypes(),
    '\n\n', soldier1.getType, 'subordinates:', soldier1.getSubordinatesTypes(),
    '\n\n', soldier2.getType, 'subordinates:', soldier2.getSubordinatesTypes(),
    '\n\n', soldier3.getType, 'subordinates:', soldier3.getSubordinatesTypes(),
  )
